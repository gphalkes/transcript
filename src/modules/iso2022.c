...
static void reset_state_jp2(converter_handle_t *handle) {
...
*/
static bool_t real_load(converter_handle_t *handle, stc_descriptor_t *desc, int g, transcript_error_t *error,
...
static bool_t probe(converter_handle_t *handle, stc_descriptor_t *desc, int g, transcript_error_t *error,
		transcript_utf_t utf_type, uint_fast8_t flags)
{
	(void) handle;
	(void) g;
...
typedef bool_t (*load_table_func)(converter_handle_t *handle, stc_descriptor_t *desc, int g, transcript_error_t *error,
	transcript_utf_t utf_type, uint_fast8_t flags);

/** Load the converters required for a specific ISO-2022 converter. */
static bool_t do_load(load_table_func load, converter_handle_t *handle, int type, transcript_utf_t utf_type, transcript_error_t *error) {
		switch (type) {
