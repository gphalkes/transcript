...
uint_fast32_t get_utf7(convertor_state_t *handle, char **inbuf, size_t *inbytesleft, t3_bool skip);
...
uint_fast32_t get_gb18030(convertor_state_t *handle, char **inbuf, size_t *inbytesleft, t3_bool skip);
