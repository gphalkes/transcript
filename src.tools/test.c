...
int main(int argc, char *argv[]) {
  ...
  static struct {
    const char *name;
    int type;
  } utf_list[] = {{"UTF-8", TRANSCRIPT_UTF8},       {"UTF-16", TRANSCRIPT_UTF16},
                  {"UTF-16BE", TRANSCRIPT_UTF16BE}, {"UTF-16LE", TRANSCRIPT_UTF16LE},
                  {"UTF-32", TRANSCRIPT_UTF32},     {"UTF-32BE", TRANSCRIPT_UTF32BE},
